                    ...
                    .then(function(result) {
                        ...
                        result.data
                            .forEach(function(product) {
                                if (product.usageType === Constants.PRODUCT_USAGE_TYPE_NORMAL_AND_ForDepartmentMeeting || product.usageType === Constants.PRODUCT_USAGE_TYPE_ONLY_ForDepartmentMeeting) {
                                    filteredProducts.push(product);
                                }
                            });
                        oViewModel.setProperty("/allProducts", filteredProducts);
                    });
            }
